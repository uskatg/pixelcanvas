...
// ---- Configuration ----------------------------------------------------------
const DEFAULT_W = 32, DEFAULT_H = 32;
...
// Bild 1 (720×720) → square; Bild 2 (720×475) → landscape.
const TASK_DIMS = { "1": { w: 32, h: 32 }, "2": { w: 32, h: 21 } };
...
async function paintCells(cells) { // [{ off, ch }]
